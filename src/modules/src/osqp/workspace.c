/*
 * This file was autogenerated by OSQP-Matlab on November 17, 2020 at 14:06:02.
 * 
...
OSQPSettings settings = {(c_float)1.38200164026433758302, (c_float)0.00000100000000000000, 10, 4000, (c_float)0.00100000000000000002, (c_float)0.00100000000000000002, (c_float)0.00010000000000000000, (c_float)0.00010000000000000000, (c_float)1.00000000000000000000, (enum linsys_solver_type) LINSYS_SOLVER, 0, 25, 1, };
...
(c_float)-1.38013194806056582742,
(c_float)-1.38106647776307922548,
(c_float)0.41986029743294056571,
(c_float)0.14854354706587472035,
(c_float)-1.32806463246387540522,
};
csc linsys_solver_L = {139821259501064, 5, 5, linsys_solver_L_p, linsys_solver_L_i, linsys_solver_L_x, -1};
c_float linsys_solver_Dinv[5] = {
(c_float)-1.38200164026433758302,
(c_float)-1.38200164026433758302,
(c_float)0.42014459772713236285,
(c_float)-2.37925417322003873721,
(c_float)0.32604579404860112302,
};
...
(c_float)0.00072358814263688467,
(c_float)0.72358814263688464585,
(c_float)0.72358814263688464585,
};
...
(c_float)1382.00164026433753861056,
(c_float)1.38200164026433758302,
(c_float)1.38200164026433758302,
};
