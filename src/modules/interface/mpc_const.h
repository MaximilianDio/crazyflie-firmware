...
enum { 
MPC_HOR = 12,  /**< MPC prediction horizon. */
MPC_STATES = 4,  /**< Number of system states. */
MPC_INPUTS = 2,  /**< Number of system inputs. */
MPC_MXCONSTRS = 0, /**< Number of mixed stage constraints. */
MPC_HOR_INPUTS = 24,  /**< Horizon times number of inputs. */
MPC_HOR_STATES = 48,  /**< Horizon times number of states. */
